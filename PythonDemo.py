...
while count != 0:
        ...
        # print("6dof: position x = {:.4f}, y = {:.4f}, z = {:.4f}, pitch = {:.4f}, yaw = {:.4f}, roll = {:.4f}, quaternion[0] = {:.4f}, quaternion[1] = {:.4f}, quaternion[2] = {:.4f}, quaternion[3] = {:.4f}, edgeTimestamp = {:.4f}, hostTimestamp = {:.4f}, confidence = {:.4f}".format(
            ...
            # slam_edgeTimestamp.value, slam_hostTimestamp.value, slam_confidence.value))
        ...
        print("6dof: position x = {:.4f}, y = {:.4f}, z = {:.4f}, pitch = {:.4f}, yaw = {:.4f}, roll = {:.4f}, confidence = {:.4f}".format(
            position.x, position.y, position.z,
            orientation.x * 180 / 3.14, orientation.y * 180 / 3.14, orientation.z * 180 / 3.14,
